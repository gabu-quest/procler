import{L as p,I as e,aR as N,aS as F,O as G,K as x,M,d as E,bd as H,p as n,bj as K,Q,S as L,bn as W,s as B,am as T,V as q,b7 as J}from"./index-DrsDzM1D.js";import{g as U}from"./Tag-C0qH9jeS.js";function _(r,b="default",a=[]){const{children:i}=r;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`

...
`,[_(">",[i("clear",`
 ...
 `,[sr({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),pe=D({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(r){return Re("-base-clear",Er,he(r,"clsPrefix")),{handleMouseDown(u){u.preventDefault()}}},render(){const{clsPrefix:r}=this;return t("div",{class:`${r}-base-clear`},t(cr,null,{default:()=>{var u,p;return this.show?t("div",{key:"dismiss",class:`${r}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},Y(this.$slots.icon,()=>[t(ne,{clsPrefix:r},{default:()=>t(Pr,null)})])):t("div",{key:"icon",class:`${r}-base-clear__placeholder`},(p=(u=this.$slots).placeholder)===null||p===void 0?void 0:p.call(u))}}))}}),Tr=D({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(r,{slots:u}){return()=>{const{clsPrefix:p}=r;return t(ur,{clsPrefix:p,class:`${p}-base-suffix`,strokeWidth:24,scale:.85,show:r.loading},{default:()=>r.showArrow?t(pe,{clsPrefix:p,show:r.showClear,onClear:r.onClear},{placeholder:()=>t(ne,{clsPrefix:p,class:`${p}-base-suffix__arrow`},{default:()=>Y(u.default,()=>[t(Br,null)])})}):null})}}}),Be=dr("n-input"),Ir=b("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
